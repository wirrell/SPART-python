...
def test_calculate_spectral_convolution(sensor, default_SPARTSimulation):
    ...
    La = calculate_spectral_convolution(ETpar["wl_Ea"], Ra, wl_srf, p_srf)
    np.testing.assert_array_almost_equal(La[0], exp)
    assert True
